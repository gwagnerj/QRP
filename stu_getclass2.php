...
//! this file is the same as stu_getclass.php except it is called and returned from WriteQuestion.php (these files need refactored into one file)
...
if (isset($_POST['cclass_id'])) {  // coming from this form and has selected the class
    ...
    $_SESSION['student_id'] = $student_id;
        header('Location: writeQuestion.php');
        return;
} else if (isset($_POST['student_id'])) {  //coming in from writeQuestion
    $student_id = $_POST['student_id'];
