...
<form method="POST">
	...
	<p><font color=#003399>Prep Time in Minutes for Plan - Half Silent</font><input type="number" name="prep_time" id="prep_time" value = 5 size=3 required min = "1" max = "15" ></p>
	...
	<p><font color=#003399>Post Time in Minutes for Reflection - Half Silent </font><input type="number" name="post_time" id="post_time" value = 5 size=3 required min = "1" max = "15" ></p>
