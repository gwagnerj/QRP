...
// get the users_id
  ...
  //-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------      
           // Using the html file as a template provide markup so that the system can more easily modify it use problem_id----------------------------------------------------------------
           // this code came from format_html that uses the varaible problem_id  so that is what I am using in this section
