...
<div id="wrapper">
	...
	<p>
		...
		Open <a href="demo.php">demo.php</a> <i>(John)</i> or <a href="demo2.php">demo2.php</a> <i>(Elizabeth)</i> or <a href="demo3.php">demo3.php</a> <i>(Joseph)</i> in a different browser to type yourself back!
