...
// put the points next to the reflections
   ...
   // const pausetime = 50;
// turn this into a function instead of repeating 3 times

   const vid1_flag = document.getElementById("vid1_html5_api")
   console.log ("vid1_flag "+vid1_flag);
   if (vid1_flag){
  //  videojs(vid1_flag).dispose();
        const myPlayer1 = videojs('vid1_html5_api', {
      ...
      //   myPlayer1.on('timeupdate', function(e) {
      //   if (myPlayer1.currentTime() >= pausetime) {
      //       myPlayer1.pause();
      //   }
      //   });
      //   function skip(t) {
      //   myPlayer1.currentTime(myPlayer1.currentTime() +t);
      //   }
       }


      const vid2_flag = document.getElementById("vid2")
  // console.log ("vid2_flag "+vid2_flag);
   if (vid2_flag){
      ...
      //   myPlayer2.on('timeupdate', function(e) {
      //   if (myPlayer2.currentTime() >= pausetime) {
      //       myPlayer2.pause();
      //   }
      //   });
      //   function skip(t) {
      //   myPlayer2.currentTime(myPlayer2.currentTime() +t);
      //   }
       }


      const vid3_flag = document.getElementById("vid3")
  // console.log ("vid3_flag "+vid3_flag);
   if (vid3_flag){
        const myPlayer3 = videojs('vid3', {
        playbackRates: [0.5,0.75, 1, 1.25, 1.5],
        controlBar: {
        fullscreenToggle: true,
        playToggle: true,
      ...
      //   myPlayer3.on('timeupdate', function(e) {
      //   if (myPlayer3.currentTime() >= pausetime) {
      //       myPlayer3.pause();
      //   }
      //   });

      //   function skip(t) {
      //   myPlayer3.currentTime(myPlayer3.currentTime() +t);
      //   }
       }
