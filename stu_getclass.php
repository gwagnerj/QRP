<?php
    ...
    if (isset($_POST['cclass_id'])){
       ...
       $sql = 'SELECT COUNT(pin) as counts FROM StudentCurrentClassConnect WHERE currentclass_id = :currentclass_id AND student_id = :student_id';
       $stmt = $pdo->prepare($sql);
         $stmt->execute(array(':currentclass_id' => $currentclass_id,':student_id' => $student_id ));
      ...
      $sql = 'SELECT MAX(pin) AS largestpin FROM StudentCurrentClassConnect WHERE currentclass_id = :currentclass_id';
        $stmt = $pdo->prepare($sql);
        ...
        $sql = 'INSERT INTO StudentCurrentClassConnect (currentclass_id, student_id, pin) VALUES (:currentclass_id, :student_id, :pin)';
        $stmt = $pdo->prepare($sql);
        $stmt->execute(array(
