			 ...
			 foreach ($gameaction_data as $gameaction_datum){
				...
				if (isset($gameaction_datum["action_image_file"])){$action_image_file = '<img src = " '.$gameaction_datum["action_image_file"].'">';} else {$action_image_file ='';}
				 ...
				 $cards[$k] = '<div class = "action_card card_container">'.
				 	'<div class = "card" id = "card_'.$gameaction_datum["gameaction_id"].'">
							...
							'</div>'.
					'</div> <div class = "remove_button"> <button class ="button" type="button" id = "removebutton_'.$gameaction_datum["gameaction_id"].'" value = "'.$gameaction_datum["gameaction_id"].'"></button> </div>'.
					'</div>';
					$k=$k+1;
				}
				...
				foreach ($gamechaos_data as $gamechaos_datum){
					...
					<div class= "card" id = "card_'.$gamechaos_datum["gamechaos_id"].'">
						...
						'</div>'.
						'</div> <div class = "remove_button"> <button class ="button" type="button" id = "removebutton_'.$gamechaos_datum["gamechaos_id"].'" value = "'.$gamechaos_datum["gamechaos_id"].'"></button> </div>'.
					'</div>';
...
<h2>&nbsp;&nbsp; Discuss with Team Captain the Cards to Select </h2>
<h3> &nbsp;&nbsp;&nbsp; (Team Captain Selects Cards) </h3>


<h2><span id = "team_score" value = "<?php echo $team_score; ?>">&nbsp;&nbsp;&nbsp; Action Points Earned: <?php echo $team_score; ?> </span>  </h2>
<?php if ($chaos_team == 1){
