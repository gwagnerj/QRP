<?php
	...
	session_start();
//! put the add a Class, Extend a class, delete a class, Add a student, Remove a student  possibly select defaults for a class	
    ...
    $iid = $_GET['iid'];
	 ...
	 $_SESSION['error'] = 'invalid User_id in QRClassMgmt ';
...
<meta Charset = "utf-8">
<title>QR Class Management</title>
...
<body>
<header>
<h1>Quick Response Class Management</h1>
</header>
...
<form id = "the_form"  method = "POST" target = "_blank">
    ...
    <div id ="current_class_dd">	
               ...
               <p><input type="submit" formaction="QRAddClass.php" value="Add a Class">  &nbsp;&nbsp;<br>
