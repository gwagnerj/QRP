<?php
	...
	$Bypass = 0;
		...
		// initialize a few variables
			...
			$time_sleep2 = 28;  // additional time if hit the next limit
			$time_sleep2_trip = 15;	
	...
	<?php if (isset($_POST['pin']) and $changed[0] and @$wrongCount[0]>=$time_sleep2_trip and $corr['a']=="Not Correct"){echo ("   Please, look for your error - time delay - ".$time_sleep2." s"); sleep($time_sleep2);} ?>
	  </p>
	<?php } 
	...
	<?php if (isset($_POST['pin']) and $changed[1] and @$wrongCount[1]>=$time_sleep2_trip and $corr['b']=="Not Correct"){echo ("   Please, look for your error - time delay -  ".$time_sleep2." s"); sleep($time_sleep2);} ?>
	</p>
	<?php } 
	...
	<?php if (isset($_POST['pin']) and $changed[2] and @$wrongCount[2]>=$time_sleep2_trip and $corr['c']=="Not Correct"){echo ("   Please, look for your error - time delay -  ".$time_sleep2." s"); sleep($time_sleep2);} ?>
	</p>
	<?php } 
	...
	<?php if (isset($_POST['pin']) and $changed[3] and @$wrongCount[3]>=$time_sleep2_trip and $corr['d']=="Not Correct"){echo ("   Please, look for your error - time delay -  ".$time_sleep2." s"); sleep($time_sleep2);} ?>
	...
	<?php if (isset($_POST['pin']) and $changed[4] and @$wrongCount[4]>=$time_sleep2_trip and $corr['e']=="Not Correct"){echo ("   Please, look for your error - time delay -  ".$time_sleep2." s"); sleep($time_sleep2);} ?>
	</p>
	<?php } 
	...
	<?php if (isset($_POST['pin']) and $changed[5] and @$wrongCount[5]>=$time_sleep2_trip and $corr['f']=="Not Correct"){echo ("   Please, look for your error - time delay -  ".$time_sleep2." s"); sleep($time_sleep2);} ?>
	</p>
	<?php } 
	...
	<?php if (isset($_POST['pin']) and $changed[6] and @$wrongCount[6]>=$time_sleep2_trip and $corr['g']=="Not Correct"){echo ("   Please, look for your error - time delay -  ".$time_sleep2." s"); sleep($time_sleep2);} ?>
	</p>
	<?php } 
	...
	<?php if (isset($_POST['pin']) and $changed[7] and @$wrongCount[7]>=$time_sleep2_trip and $corr['h']=="Not Correct"){echo ("   Please, look for your error - time delay -  ".$time_sleep2." s"); sleep($time_sleep2);} ?>
	</p>
	<?php } 
	...
	<?php if (isset($_POST['pin']) and $changed[8] and @$wrongCount[8]>=$time_sleep2_trip and $corr['i']=="Not Correct"){echo ("   Please, look for your error - time delay -  ".$time_sleep2." s"); sleep($time_sleep2);} ?>
	</p>
	<?php } 
	...
	<?php if (isset($_POST['pin']) and $changed[9] and @$wrongCount[9]>=$time_sleep2_trip and $corr['j']=="Not Correct"){echo ("   Please, look for your error - time delay -  ".$time_sleep2." s"); sleep($time_sleep2);} ?>
	</p>
	<?php } 
