...
// Search thru all of the document looking for the image markups and put divs for those
...
for (i=0;i<numImages;i++){
	...
	document.querySelectorAll('p')[i].setAttribute('id',eTag);
	
	document.images[i].setAttribute('id',sTag);
	// document.querySelectorAll('.MsoCaption')[i].setAttribute('id',eTag);
	



// document.querySelector('img').setAttribute("id","start1");


	
}	
document.images[0].setAttribute('id','start1');
document.querySelector('.MsoCaption').setAttribute('id','end1');

// var myImage = document.querySelector('img');
//var mySrc = myImage.getAttribute('src');
//console.log(mySrc);
var myCaption = document.querySelector('.MsoCaption').outerHTML; 
console.log(myCaption);
// myCaption2 = myCaption.outerHTML;


//console.log(myCaption2);

// Extracting the figure 
var capNum = myCaption.indexOf("</p>");
console.log(capNum);
var figNum = myCaption.slice(capNum-2,capNum).trim();
console.log(figNum);

var indexStart = myCaption.indexOf("##");
var indexEnd = myCaption.indexOf(",img",indexStart);
var divID = myCaption.slice(indexStart+2,indexEnd)+'_'+figNum;
...
// this is a test to see if I can put images in swapping them out as needbe

/* var oldImage = $("#Picture\\ 3").attr("src");

console.log(oldImage);

var imagePath = oldImage.slice(0, oldImage.lastIndexOf("/")+1) + var1;
$("#Picture\\ 3").attr("src", imagePath ); 
